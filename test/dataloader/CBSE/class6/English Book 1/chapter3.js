                    ...
                    describe("add a chapter of a subject", () => {
                        it("It should add a chapter to English for Class 6", (done) => {
                            chai.request('localhost:3001')
                                ...
                                .set('Content-Type', 'application/json')
                                .set('auth-token', jwtToken)
                                .send({"indx": 3, "chapterName": " How the Dog Found Himself a Master!","chapterDesc":"DOGS were once their own masters and lived the way wolves do, in freedom, until a dog was born who was ill pleased with this way of life. He was sick and tired of wandering about by himself"})
