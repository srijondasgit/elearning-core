                    ...
                    describe("add a chapter of a subject", () => {
                        it("It should add a chapter to English for Class 6", (done) => {
                            chai.request('localhost:3001')
                                ...
                                .set('Content-Type', 'application/json')
                                .set('auth-token', jwtToken)
                                .send({"indx": 4, "chapterName": "The Kite?","chapterDesc":"How bright on the blue Is a kite when it’s new! With a dive and a dip It snaps its How bright on the blue Is a kite when it’s new! With a dive and a dip It snaps its tailf"})
